...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/article/status/{status}', [ArticleController::class, 'index'])->name('article.filter');

    Route::get('/admin/article-spintax', [ArticleController::class, 'indexspintax'])->name('article.spintax');
    Route::get('/admin/article-spintax/status/{status}', [ArticleController::class, 'indexspintax'])->name('article.spintax.filter');

    Route::get('/admin/article-unique', [ArticleController::class, 'indexunique'])->name('article.unique');
    Route::get('/admin/article-unique/status/{status}', [ArticleController::class, 'indexunique'])->name('article.unique.filter');
